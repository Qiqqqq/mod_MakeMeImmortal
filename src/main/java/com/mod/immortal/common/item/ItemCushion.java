...
public class ItemCushion extends ItemMod {
	
	public ItemCushion() {
		super(ItemNames.CUSHION);
	}
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        else
        {
            ...
            {
                EntityCushion entityCushion = new EntityCushion(worldIn, raytraceresult.hitVec.x, raytraceresult.hitVec.y, raytraceresult.hitVec.z);
                entityCushion.rotationYaw = playerIn.rotationYaw;

                if (!worldIn.getCollisionBoxes(entityCushion, entityCushion.getEntityBoundingBox().grow(-0.1D)).isEmpty())
                {
