...
public class ItemNames {
    ...
    public static final String FU_JIN = "fuJin";
    public static final String FU_HUO = "fuHuo";
    public static final String FU_SHUI = "fuShui";
    public static final String FU_TU = "fuTu";
