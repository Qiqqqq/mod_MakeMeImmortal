...
public class ImmortalWorldSavedData extends WorldSavedData
{
    ...
    public static ImmortalWorldSavedData instClient = new ImmortalWorldSavedData("ImmortalHolyLands");
    ...
    public boolean add(Vec3i position, String name)
    {
    ...
    public static ImmortalWorldSavedData get(World world) {
    	...
    	return (ImmortalWorldSavedData)data;
    }
